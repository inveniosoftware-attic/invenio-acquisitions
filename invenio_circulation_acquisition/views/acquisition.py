...
"""invenio-circulation-acquisition interface."""
...
def acquisition_request(record_id=None):
    """Interface to request an acquisition for the user.
...
def purchase_request(record_id=0):
    """Interface to request a purchase for the user.
...
def acquisition_register(record_id=None):
    """Interface to register an acquisition for the administrator.
...
def purchase_register(record_id=None):
    """Interface to register a purchase for the administrator.
...
def register_acquisition():
    """API to register an acquisition for the administrator."""
...
def request_acquisition():
    """API to request an acquisition for the user."""
    try:
